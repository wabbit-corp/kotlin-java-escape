...
- Canonical repo target: `kotlin-java-escape`. Useful entrypoints: `dev project show kotlin-java-escape`, `dev build kotlin-java-escape`, `dev check kotlin-java-escape`.
- Setup-managed files are regenerated with `dev setup kotlin-java-escape`; avoid hand-editing stamped generated files.
